            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '16px' }}>
              <button
                ...
                style={{
                  ...
                  border: '1px solid',
                  borderColor: activeTab === 'CODE' ? '#d1d5db' : 'var(--border-color)',
                  background: activeTab === 'CODE' ? '#e5e7eb' : 'var(--bg-secondary)',
                  color: activeTab === 'CODE' ? '#1f2937' : 'var(--text-primary)',
                  cursor: 'pointer',
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: '"Times New Roman", Georgia, serif',
                  border: '1px solid',
                  borderColor: activeTab === 'PHONE' ? '#d1d5db' : 'var(--border-color)',
                  background: activeTab === 'PHONE' ? '#e5e7eb' : 'var(--bg-secondary)',
                  color: activeTab === 'PHONE' ? '#1f2937' : 'var(--text-primary)',
                  cursor: 'pointer',
                  transition: 'all 0.15s ease'
                }}
              >
