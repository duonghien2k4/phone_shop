                ...
                {BRANDS.map(brand => (
                  <button
                    ...
                    style={{
                      ...
                      border: '1px solid',
                      borderColor: selectedBrand === brand ? '#d1d5db' : 'var(--border-color)',
                      background: selectedBrand === brand ? '#e5e7eb' : 'var(--bg-secondary)',
                      color: selectedBrand === brand ? '#1f2937' : 'var(--text-primary)',
                      cursor: 'pointer',
                      whiteSpace: 'nowrap',
                  ...
                  {PRICE_RANGES.map((range, idx) => (
                    <button
                      ...
                      style={{
                        ...
                        border: '1px solid',
                        borderColor: selectedPriceRange === idx ? '#d1d5db' : 'var(--border-color)',
                        background: selectedPriceRange === idx ? '#e5e7eb' : 'transparent',
                        color: selectedPriceRange === idx ? '#1f2937' : 'var(--text-secondary)',
                        cursor: 'pointer'
                      }}
                    >
                      {range.label}
