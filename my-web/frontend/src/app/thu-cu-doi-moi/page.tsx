    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'var(--bg-secondary)' }}>
      ...
      <main style={{ flexGrow: 1, padding: '24px 0 64px' }}>
        <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '0 16px' }}>
          ...
          <div 
            style={{
              background: 'linear-gradient(135deg, #facc15 0%, #fde68a 30%, #fff7d6 60%, #ffffff 100%)',
              borderRadius: '24px',
              padding: '36px 32px',
              color: '#1f2937',
              marginBottom: '28px',
              boxShadow: '0 12px 32px rgba(250, 204, 21, 0.2)',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <div style={{ maxWidth: '600px' }}>
              <span style={{ background: 'rgba(255,255,255,0.7)', padding: '6px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px', display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#433701', fontFamily: '"Times New Roman", Georgia, serif' }}>
                <Sparkles size={14} /> Sóc AI Thu Cũ - Trợ Giá Tất Cả Các Dòng Máy
              </span>
              <h1 style={{ fontSize: '2.1rem', fontWeight: 900, margin: '12px 0 8px', lineHeight: 1.2, color: '#111827', fontFamily: '"Times New Roman", Georgia, serif', letterSpacing: '0px' }}>
                ĐỊNH GIÁ THU CỦ TỰ ĐỘNG BẰNG AI - TRỢ GIÁ LÊN ĐỜI 1.000.000Đ
              </h1>
              <p style={{ fontSize: '14px', opacity: 0.9, lineHeight: 1.5, margin: 0, color: '#374151', fontFamily: '"Times New Roman", Georgia, serif', fontWeight: 600 }}>
                Nhận báo giá dự kiến tức thì cho <strong style={{ fontFamily: '"Times New Roman", Georgia, serif', fontWeight: 700 }}>tất cả các dòng điện thoại</strong> (iPhone, Samsung, Xiaomi, OPPO, Realme, Google Pixel...). Trụ sở chính: <strong style={{ fontFamily: '"Times New Roman", Georgia, serif', fontWeight: 700 }}>Số 180 Nguyễn Trãi, Q. Thanh Xuân, Hà Nội</strong>.
              </p>
            </div>
